...
import pointIcon from "../../../../assets/images/ic_point.svg";
...
const StudyCard = ({
  ...
  const progressDateColor = getProgressDateColor(background);
    ...
    >
      <div className="study-card__title__container">
        <h2 className="study-card__title">
          ...
          <span
            className="study-card__title__study-name"
            style={{ color: anotherColor }}
          >
            의 {studyName}
          </span>
        </h2>
        <div
          className="study-card__point-container"
      ...
      <div className="study-card__date" style={{ color: progressDateColor }}>
        {days}일째 진행중
      </div>
      ...
      <div className="study-card__emoji-container">
        <Emojis
          showExtraEmojisBtn={false}
          showAddEmojiBtn={false}
          studyId={id}
        />
      </div>
    </Link>
